...
public class TestCarRegistration {
    ...
    public static void main(String[] args) {
        ...
        for (int i = 0; i < registration.length; ++i) {
            ...
            OwnerInfo owner = new OwnerInfo(name, icNo);
            ...
            CarInfo car = new CarInfo(plateNum, color, year, types[selection - 1]);
    ...
    public static void displayListing(Registration[] regArr) {
        ...
        System.out.printf("%15s %12s %12s %10s %8s %6s %10s %10s %15s\n",
